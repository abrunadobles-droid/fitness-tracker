"""
Fitness Tracker 2026 - CORREGIDO
"""
...
def get_monthly_data(year, month):
    ...
    data = {
        ...
        'hr_zone_1_3_total': 0, 'hr_zone_4_5_total': 0,
    ...
    try:
        ...
        # CORREGIDO: Total mensual en HORAS (no multiplicar por semanas)
        # La API ya nos da el promedio semanal, así que multiplicamos por ~4.3 semanas
        # PERO según WHOOP, deberíamos tener el TOTAL del mes
        # Vamos a calcular diferente: total de TODOS los workouts del mes
        ...
        # Convertir a HORAS
        data['hr_zone_1_3_total'] = round(total_zone_1_3_ms / 3600000, 1)
        data['hr_zone_4_5_total'] = round(total_zone_4_5_ms / 3600000, 1)
        ...
        print(f"   ✅ HR Zones 1-3: {data['hr_zone_1_3_total']}h total")
        print(f"   ✅ HR Zones 4-5: {data['hr_zone_4_5_total']}h total")
...
ws[f'B{row}'] = 7.5
row += 1
ws[f'A{row}'] = 'Time HR Zones 1-3 (H total)'
ws[f'B{row}'] = 19.3  # Basado en WHOOP real
row += 1
ws[f'A{row}'] = 'Time HR Zones 4-5 (H total)'
ws[f'B{row}'] = 2.9
habitos_end_row = row
row += 1
...
ws['C10'] = enero_data['hr_zone_1_3_total']
ws['C11'] = enero_data['hr_zone_4_5_total']
...
for col_idx in range(3, 15):
    ...
    # Aplicar formato de número con comas a columnas de datos
...
print(f"   ✅ Formato con comas: 10,000")
print(f"   ✅ HR Zones corregidos (total mensual)")
print("="*70 + "\n")
